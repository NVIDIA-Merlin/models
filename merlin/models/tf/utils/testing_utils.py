    ...
    **kwargs,
    ...
    if reload_model:
        ...
        if model.schema:
            ...
            # TODO: once we are able to enforce that no extra params may be passed
            # this can be changed to an assert equal check
            assert signature_input_names.issubset(set(model_input_names))
