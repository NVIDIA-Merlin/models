...
def WideAndDeepModel(
    ...
    **kwargs
    ...
    wide_schema : optional
        ...
        to wide model, if defined, only features in wide_schema would be sent to wide model
    ...
    # TODO: create a cross-product block, instead of using NVTabular for pre-process
    if not wide_schema:
        warnings.warn(
