...
def get_drepessi2022(input_path):
    """
    ...
    3. Run `get_drepessi2022(data_dir)` to convert the data to Merlin datasets
    ...
    Synthetic data can be generated by running::
        ...
        train, valid = generate_data("drepessi2022-preprocessed")
