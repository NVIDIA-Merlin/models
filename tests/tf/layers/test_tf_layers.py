...
# layers = pytest.importorskip("merlin_models.tf.layers")
#
#
...
#         multi_hot_embedding = tf.feature_column.embedding_column(multi_hot, 100,
#         combiner=combiner)
...
#     inputs = {
#         "scalar_continuous": tf.keras.Input(name="scalar_continuous", shape=(1,),
#         dtype=tf.float32),
...
# @pytest.mark.parametrize("interaction_type", [None, "field_all", "field_each",
# "field_interaction"])
