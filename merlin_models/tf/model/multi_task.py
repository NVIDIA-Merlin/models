...
from ..block.multi_task import MMOEGate, MultiExpertsBlock, CGCBlock
...
class PLEHead(Head):
    def __init__(
        ...
        super().__init__(body, prediction_tasks, task_blocks, task_weights, bias_block,
                         loss_reduction, inputs, **kwargs)
        cgc_blocks = []
        for i in range(depth):
            cgc_blocks.append(
                CGCBlock(expert_block, prediction_tasks, num_task_experts, num_shared_experts,
                         is_last=i == depth))
