...
Alternatively, you can [install Merlin Models from source](../README.md#installing-merlin-models-from-source() and other required libraries to run the notebooks on your host.
